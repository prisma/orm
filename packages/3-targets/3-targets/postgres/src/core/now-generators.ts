import { PG_TIMESTAMP_TEMPORAL_CODEC_ID, PG_TIMESTAMPTZ_TEMPORAL_CODEC_ID } from './codec-ids';
...
/** The "now" generator for each codec that has one: each generates the value its codec encodes. */
