...
-- AddForeignKey
ALTER TABLE "one"."_PostToTag" ADD CONSTRAINT "_PostToTag_B_fkey" FOREIGN KEY ("B") REFERENCES "one"."Tag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
