...
export type StorageHash =
  StorageHashBase<'0802020fe7c66e5060038b8fa6f608ae426c3ab22c1a3dd97bd84a0c28dfd2ea'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Probe: {
      ...
      readonly moods: ReadonlyArray<'URGENT' | 'NORMAL' | 'LOW'>;
        ...
        readonly entries: {
          ...
          readonly valueSet: {
            readonly Mood: {
              ...
              readonly values: readonly ['URGENT', 'NORMAL', 'LOW'];
            };
          };
        };
      };
...
> & {
  ...
  readonly roots: {
    readonly probe: { readonly namespace: 'public' & NamespaceId; readonly model: 'Probe' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          readonly Probe: {
            ...
            readonly storage: {
              readonly table: 'probe';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly moods: { readonly column: 'moods' };
